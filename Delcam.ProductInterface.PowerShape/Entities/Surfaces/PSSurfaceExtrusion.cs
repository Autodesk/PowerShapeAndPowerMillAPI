...
namespace Autodesk.ProductInterface.PowerSHAPE
{
    ...
    /// </summary>
    public class PSSurfaceExtrusion : PSPrimitive
    {
        #region " Fields "
            ...
            PSWireframe[] wireframeToExtrude) : base(powershape)
        {
            ...
            _powerSHAPE.DoCommand("CREATE SURFACE EXTRUSION", "ACCEPT");

            // Get created plane id
            PSSurfaceExtrusion newExtrusion = (PSSurfaceExtrusion) _powerSHAPE.ActiveModel.CreatedItems[0];
            _id = newExtrusion.Id;
        }
